...
public class WebSocketService extends Service implements SocketListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        mWebSocketThread = new WebSocketThread(WebSocketSetting.getConnectUrl(), WebSocketSetting.getHeaders(), WebSocketSetting.getSocketDelegate());
        ...
        if (WebSocketSetting.isReconnectWithNetworkChanged()) {
            ...
            if (manager == null || manager.getActiveNetworkInfo() == null) {
                networkChangedReceiverRegist = false;
            } else {
                networkChangedReceiver = new NetworkChangedReceiver(manager.getActiveNetworkInfo().getType(), this);
    ...
    public void onDestroy() {
        if(mWebSocketThread != null && mWebSocketThread.getHandler() != null){
