 ...
 */
public class KeyboardNext extends com.dilusense.customkeyboard.BaseKeyboard {
    ...
    public KeyboardNext() {
        init(ActivityManager.getInstance(), R.xml.keyboard_identity);
    ...
    public void init(Activity activity, int layoutResId) {
        ...
        mKeyboardView = (MyKeyBoardView) mActivity.findViewById(com.dilusense.customkeyboard.R.id.keyboard_view);
    }
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            if (primaryCode == Keyboard.KEYCODE_DELETE) {// 回退
                if (editable != null && editable.length() > 0) {
                    ...
                    if(mOnDeleteNoneClick != null){
                        mOnDeleteNoneClick.onDeleteNoneClick(mEditText);
                    }
                }
    ...
    public interface OnDeleteNoneClick {
        void onDeleteNoneClick(EditText editText);
    }
    ...
    public OnDeleteNoneClick mOnDeleteNoneClick = null;
    public onCancelClick mOnCancelClick;

    public void setOnDeleteNoneClick(OnDeleteNoneClick mOnDeleteNoneClick) {
        this.mOnDeleteNoneClick = mOnDeleteNoneClick;
    }
