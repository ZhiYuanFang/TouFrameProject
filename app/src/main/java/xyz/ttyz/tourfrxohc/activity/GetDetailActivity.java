        ...
        public void callBackState(boolean[] readArr) {
            ...
            for (CarModel carModel: selectList) {
                if(readArr[carModel.getDoorNumber() - 1] ){
                    ...
                    new RxOHCUtils<>(ActivityManager.getInstance()).executeApi(BaseApplication.apiService.afterTakeOutBoxKey(RetrofitUtils.getNormalBody(map)), new BaseSubscriber<Object>(GetDetailActivity.this) {
                        @Override
